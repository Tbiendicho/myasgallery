 ...
 */
final class Version20211025091614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, road_number INT DEFAULT NULL, road_name VARCHAR(255) NOT NULL, road_name2 VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(20) NOT NULL, town VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, addresses_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, information LONGTEXT NOT NULL, date DATETIME NOT NULL, localisation VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_3BAE0AA75713BC80 (addresses_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA75713BC80 FOREIGN KEY (addresses_id) REFERENCES address (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY FK_3BAE0AA75713BC80');
